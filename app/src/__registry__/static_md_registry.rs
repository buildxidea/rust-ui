...
pub fn MyMd(
    ...
    combined_components.add("StaticInstallScrollLock", StaticInstallScrollLock);
...
#[component]
fn StaticInstallScrollLock() -> impl IntoView {
    view! { <StaticInstallWrapper install_type=MarkdownType::StaticInstallScrollLock /> }
}
